 ...
 * @author usu
 */
public final class passwdShadow extends JPasswordField{
...
//             
//                TextFieldShadowText text = new TextFieldShadowText();
//                text.setColumns(30);
//                text.setShadowText("SHADOW TEXT");               
//            });
//        } catch (ClassNotFoundException | InstantiationException | IllegalAccessException | UnsupportedLookAndFeelException ex) {
//            Logger.getLogger(TextFieldShadowText.class.getName()).log(Level.SEVERE, null, ex);
//        }
//    }
